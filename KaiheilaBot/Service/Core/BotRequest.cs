...
namespace KaiheilaBot.Core
{
    public class BotRequest: IBotRequest
    {
        ...
        /// </summary>
        public BotRequest(Config config)
        {
            rest = new RestClient();
            rest.BaseUrl = new Uri("https://www.kaiheila.cn/api/v3/");
            rest.AddDefaultHeader("Authorization", $"Bot {config.Token}");
        ...
        public IBotRequest AddParameter<T>(string parameterName, T parameter)
        {
        ...
        /// <returns>当前 BotRequest 实例</returns>
        public IBotRequest SetMethod(Method method)
        {
            Method = method;
            return this;
        }
        ...
        /// <returns>当前 BotRequest 实例</returns>
        public IBotRequest SetUrl(string url)
        {
            Url = url;
            return this;
        }
        ...
        /// </example>
        /// <returns>当前 BotRequest 实例</returns>
        public IBotRequest AddFile(string filePath)
        {
            Url = "asset/create";
            FilePath = filePath;
            Method = Method.POST;
